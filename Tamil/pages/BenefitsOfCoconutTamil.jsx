...
const BenefitsOfCoconutTamil = () => {
  ...
  <img
    ...
    alt="Logo"
    className="logo-image w-16 sm:w-20 md:w-24 lg:w-28 mx-auto" // Adjust these values to fit your needs
  />
</div>
...
export default BenefitsOfCoconutTamil;
