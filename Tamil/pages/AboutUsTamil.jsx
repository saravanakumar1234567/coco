      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            ...
            >
              <strong>தென்னை</strong>யில், நாங்கள் தேங்காய் விவசாயிகளுக்கு தகவல், கருவிகள் மற்றும் சமூகத் தொடர்புகளை வழங்க உறுதியாக இருக்கிறோம். 
              எங்கள் இலக்கு விவசாயத்தை எளிமையாக்கி, லாபகரமாகவும் நிலைத்தன்மையாகவும் மாற்றுவது ஆகும்.
            </motion.p>
          </div>
          <motion.div
